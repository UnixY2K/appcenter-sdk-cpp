#pragma once
#include <appcenter/channel/Flag.hpp>
#include <appcenter/channel/Listener.hpp>
#include <appcenter/ingestion/ingestion.hpp>
#include <string>
...
class Channel {
  public:
	 ...
	 */
	void setAppSecret(std::string appSecret);
	...
	void addGroup(std::string groupName, int maxLogsPerBatch,
	              ...
	              appcenter::ingestion::Ingestion ingestion,
